export const History = () => {
  return (
    <>
      <p id="history"  className="flex flex-col items-center justify-center h-screen">
        ...
        <p className="md:w-1/2 p-3 mx-auto text-center text-justify">
          ...
          “Equi-ethos”. Con esta transformación buscamos ir más allá de nuestras
          actividades iniciales, incorporando la reflexión y la filosofía en
          nuestras propuestas. La idea se inspira en nuestro tiempo compartido
          como estudiantes del grado de filosofía por la UNED.{" "}
        </p>
        <p className="md:w-1/2 p-3 mx-auto text-center text-justify">
